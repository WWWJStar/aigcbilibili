...
DELIMITER //
CREATE DEFINER=`xxx`@`%` TRIGGER `increment_play_count` AFTER INSERT ON `play` FOR EACH ROW
BEGIN
UPDATE video_data
...
DELIMITER //
CREATE DEFINER=`xxx`@`%` TRIGGER `increment_comment_count` AFTER INSERT ON `comment` FOR EACH ROW
BEGIN
UPDATE video_data
...
DELIMITER //
CREATE DEFINER=`xxx`@`%` TRIGGER `increment_like_count` AFTER INSERT ON `likes` FOR EACH ROW
BEGIN
UPDATE video_data
...
DELIMITER //
CREATE DEFINER=`xxx`@`%` TRIGGER `increment_collect_count` AFTER INSERT ON `collect` FOR EACH ROW
BEGIN
UPDATE video_data
...
DELIMITER //
CREATE DEFINER=`xxx`@`%` TRIGGER `de_collect_count` AFTER DELETE ON `collect` FOR EACH ROW
BEGIN
UPDATE video_data
...
DELIMITER //
CREATE DEFINER=`xxx`@`%` TRIGGER `de_like_count` AFTER DELETE ON `likes` FOR EACH ROW
BEGIN
UPDATE video_data
...
DELIMITER //
CREATE DEFINER=`xxx`@`%` TRIGGER `increment_danmaku_count` AFTER INSERT ON `danmaku` FOR EACH ROW
BEGIN
UPDATE video_data
